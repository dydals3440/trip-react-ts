...
import useGoogleSignin from '@components/hooks/useGoogleSignin'
    ...
    <Flex direction="column" align="center" style={{ padding: 24 }}>
      ...
      <Button size="medium" onClick={signin}>
        <Flex align={'center'} justify={'center'}>
          <img
            src={
              'https://cdn3.iconfinder.com/data/icons/logos-brands-3/24/logo_brand_brands_logos_google-64.png'
            }
            height={20}
            width={20}
          />
